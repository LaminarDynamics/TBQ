...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        public Cadet.Rank GetRace()
        {
            Cadet.Rank raceType;
            Enum.TryParse<Cadet.Rank>(Console.ReadLine(), out raceType);
        ...
        public bool DisplaySpashScreen()
        {
            ...
            Console.WriteLine(tabSpace + @"       ,\\ ;     /_.:"":._.:"":._.:"":._.:"":._.:"":._.:"":\     ://,        ");
            Console.WriteLine(tabSpace + @"       / \\     /'""`:_: '""`:_:'""`:_: '""`:_: '""`:_:'""`:_: '\    // \.       ");
            Console.WriteLine(tabSpace + @"      |//_ \   ':._.:"":._.+ "":._.:"":._.:"":._.:"":._.:"":._\  / _\\ \      ");
            Console.WriteLine(tabSpace + @"     /___../  /_:'""`:_: '""`:_:'""`:_:'""`:_: '""`:_:'""`:_:'""'. \..__ |      ");
            ...
            Console.WriteLine(tabSpace + @"        \  :    \._.:"":._.:"":._.:"":._.:"":._.:"":._.:"":,'    ;  /        ");
            Console.WriteLine(tabSpace + @"        `.  \    \..--:'""`:_: '""`:_:'""`:_:'""`:_: '""`-../    /  /         ");
            Console.WriteLine(tabSpace + @"         `__.`.'' _..+'._.:"":._.:"":._.:"":._.:"":.`+._  `-,:__`          ");
            Console.WriteLine(tabSpace + @"      .-''    _ -' .'| _________________________ |`.`-.     `-.._      ");
        ...
        public Traveler GetInitialTravelerInfo()
        {
            ...
            // get traveler's race
            //
            DisplayGamePlayScreen("Mission Initialization - Rank", Text.InitializeMissionGetTravelerRace(traveler), ActionMenu.MissionIntro, "");
            DisplayInputBoxPrompt($"Enter your rank {traveler.Name}: ");
        ...
        {
            Planets currentSpaceTimeLocation = _gameUniverse.GetPlanetLocationById(_gameTraveler.PlanetLocationId);
        ...
        public void DisplayLookAround()
        {
            ...
            //
            List<TravelerObject> gameObjectsInCurrentSpaceTimeLocation = _gameUniverse.GetGameObjectsBySpaceTimeLocationId(_gameTraveler.PlanetLocationId);
        ...
        //public void DisplayAvailibleEquipment()
        //{
        //    Planets currentPlanet = _gameUniverse.GetPlanetLocationById(_gameTraveler.PlanetLocationId);
        //    DisplayGamePlayScreen("Equipment At Current Location", Text.PickUpEquipment(currentPlanet), ActionMenu.PickUpMenu, "");
        //}
        ...
        public int DisplayGetNextSpaceTimeLocation()
        {
            ...
            DisplayGamePlayScreen("Travel Through Stargate", Text.Travel(_gameTraveler, _gameUniverse.SpaceTimeLocations), ActionMenu.MainMenu, "");
            ...
            while (!validSpaceTimeLocationId)
            {
                ...
                //
                if (_gameUniverse.IsValidPlanetID(spaceTimeLocationId))
                {
        ...
        public void DisplayLocationsVisited()
        {
            ...
            //
            List<Planets> visitedSpaceTimeLocations = new List<Planets>();
            foreach (int spaceTimeLocationId in _gameTraveler.PlanetsVisited)
            {
                visitedSpaceTimeLocations.Add(_gameUniverse.GetPlanetLocationById(spaceTimeLocationId));
            }

            DisplayGamePlayScreen("Planets Visited", Text.VisitedLocations(visitedSpaceTimeLocations), ActionMenu.MainMenu, "");
        }

        public void DisplayListOfPlanetLocations()
        {
            DisplayGamePlayScreen("List: Gate Addresses", Text.ListAllPlanetLocations(_gameUniverse.SpaceTimeLocations), ActionMenu.AdminMenu, "");
        }
        ...
        public int DisplayGetTravelerObjectToPickUp()
        {
            ...
            //
            List<TravelerObject> travelerObjectsInSpaceTimeLocation = _gameUniverse.GetTravelerObjectsBySpaceTimeLocationId(_gameTraveler.PlanetLocationId);
            ...
            if (travelerObjectsInSpaceTimeLocation.Count > 0)
            {
                ...
                while (!validGameObjectId)
                {
                    ...
                    //
                    if (_gameUniverse.IsValidTravelerObjectByLocationId(gameObjectId, _gameTraveler.PlanetLocationId))
                    {
        ...
        public void DisplayGameObjectInfo(TravelerObject gameObject)
        {
        ...
        public int DisplayGetGameObjectToLookAt()
        {
            ...
            //
            List<TravelerObject> gameObjectsInSpaceTimeLocation = _gameUniverse.GetGameObjectsBySpaceTimeLocationId(_gameTraveler.PlanetLocationId);
            ...
            if (gameObjectsInSpaceTimeLocation.Count > 0)
            {
                ...
                while (!validGamerObjectId)
                {
                    ...
                    // validate integer as a valid game object id and in current location
                    //
                    if (_gameUniverse.IsValidGameObjectByLocationId(gameObjectId, _gameTraveler.PlanetLocationId))
                    {
