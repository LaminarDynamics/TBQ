...
namespace TheAionProject
{
    ...
    public class Controller
    {
        ...
        private Planets _currentLocation;
        ...
        private void InitializeGame()
        {
            ...
            //
            _gameTraveler.Inventory.Add(_gameUniverse.GetGameObjectById(2) as TravelerObject);
        ...
        private void ManageGameLoop()
        {
            ...
            //
            _currentLocation = _gameUniverse.GetPlanetLocationById(_gameTraveler.PlanetLocationId);
            ...
            while (_playingGame)
            {
                ...
                switch (travelerActionChoice)
                {
                    ...
                    //case TravelerAction.DisplayAvailibleEquipment:
                    //    _gameConsoleView.DisplayAvailibleEquipment();
                    //    travelerActionChoice = _gameConsoleView.GetActionMenuChoice(ActionMenu.PickUpMenu);
                    //    break;

                    //case TravelerAction.PickUpEquipment:
                    //    _gameTraveler.Equipment = _currentLocation.AvailibleEquipment;
                    //    break;

                    //case TravelerAction.PutDownEquipment:
                    //    _gameConsoleView.DisplayAvailibleEquipment();
                    //    break;
                    ...
                    case TravelerAction.Travel:
                        ...
                        //                        
                        _gameTraveler.PlanetLocationId = _gameConsoleView.DisplayGetNextSpaceTimeLocation();
                        _currentLocation = _gameUniverse.GetPlanetLocationById(_gameTraveler.PlanetLocationId);
                    ...
                    case TravelerAction.ListPlanets:
                        _gameConsoleView.DisplayListOfPlanetLocations();
                        break;
        ...
        private void LookAtAction()
        {
            ...
            if (gameObjectToLookAtId != 0)
            {
                ...
                //
                TravelerObject gameObject = _gameUniverse.GetGameObjectById(gameObjectToLookAtId);
        ...
        private void PickUpAction()
        {
            ...
            if (travelerObjectToPickUpId != 0)
            {
                ...
                travelerObject.PlanetLocationId = 0;
        ...
        private void PutDownAction()
        {
            ...
            travelerObject.PlanetLocationId = _gameTraveler.PlanetLocationId;
        ...
        private void InitializeMission()
        {
            ...
            _gameTraveler.PlanetLocationId = 1;

            _gameTraveler.ExperiencePoints = 0;
            _gameTraveler.Health = 100;
            _gameTraveler.Lives = 3;
            // _gameTraveler.Equipment = traveler.Equipment;
        }

        private void UpdateGameStatus()
        {
            if (!_gameTraveler.HasVisited(_currentLocation.planetLocationId))
            {
                //
                // add new location to the list of visited locations if this is a first visit
                //
                _gameTraveler.PlanetsVisited.Add(_currentLocation.planetLocationId);
